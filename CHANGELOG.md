...
### Changed
- A product the shop only sells in tens or more is costed at that amount. Search shows "min. 10" under its price, and a parts list buys at least 10 of it, in the total, the order and the cart link. Before, it was counted as one and looked cheaper than it was.

...
### Changed
- A shop's order copied as a message is headed by the shop's name, underlined, and ends with its total, so it still says where it's from when pasted elsewhere.

...
Each version in [the changelog](../CHANGELOG.md) is a git tag, so a copy of this server can be kept on a known version (`git checkout v2.0.1`) or updated with `git pull`.
